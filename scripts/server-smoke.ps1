...
Write-Output 'kterm-server smoke test passed: HTTP assets, page checkpoint and takeover protocol, Shell identity, output replay, explicit cleanup, and shutdown cleanup.'
